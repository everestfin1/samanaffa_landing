...
This guide will help you set up the backend for the Sama Naffa platform using Bun, Next.js, Drizzle ORM, and PostgreSQL.
...
### 5. Push Schema Directly (Optional for local/dev)
