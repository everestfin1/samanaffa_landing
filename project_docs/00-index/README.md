...
| [03 - Development](./03-development/) | Setup, integration, optimization | Developers |
| [04 - Integrations](./04-integrations/) | Third-party services | Developers, DevOps |
...
| [07 - Archive](./07-archive/) | Legacy docs, session summaries | Reference |
...
3. Integration guides in [04 - Integrations/](./04-integrations/)

### For DevOps & Security
1. Security docs in [05 - Security/](./05-security/)
2. Infrastructure: [02 - Architecture/04-infrastructure-fr.md](./02-architecture/04-infrastructure-fr.md)
3. Third-party integrations: [04 - Integrations/intouch/](./04-integrations/intouch/)
...
| Intouch Integration | Payment provider integration | Current |
...
- Status indicators in archive only
...
*This documentation follows a numbered folder structure for easy navigation. Each section has a README with detailed contents.*
