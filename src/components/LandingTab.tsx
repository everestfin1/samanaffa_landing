...
interface LandingTabProps {
  onNavigateToTab?: (tab: 'sama-naffa' | 'ape') => void;
}

export default function LandingTab({ onNavigateToTab }: LandingTabProps) {
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-8">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <button 
                    onClick={() => onNavigateToTab?.('sama-naffa')}
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-white/70">
                <li><button onClick={() => onNavigateToTab?.('sama-naffa')} className="hover:text-gold-metallic transition-colors">Compte épargne</button></li>
                <li><button onClick={() => onNavigateToTab?.('ape')} className="hover:text-gold-metallic transition-colors">Investissement APE</button></li>
