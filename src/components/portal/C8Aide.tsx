...
export default function C8Aide() {
  ...
  const openWhatsApp = () => {
    ...
    const whatsappNumber = SAMA_NAFFA_CONTACT.whatsapp.replace(/\D/g, '');
    window.open(
  ...
  const openClaim = () => {
    ...
    window.location.href = `mailto:${SAMA_NAFFA_CONTACT.email}?subject=${subject}&body=${body}`;
  };
