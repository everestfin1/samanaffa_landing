...
export const metadata: Metadata = {
  title: 'Educ\'épargne | EVEREST Finance',
  ...
  openGraph: {
    title: 'Educ\'épargne | EVEREST Finance',
    description: 'Assurez l\'avenir de vos enfants avec Educ\'épargne. Épargne sécurisée et rentable.',
    images: [
      {
        url: '/pee/Banniere_PEE_3.png',
        width: 1200,
        height: 630,
        alt: 'Bannière Educ\'épargne Everest Finance',
      },
    ],
  },
  icons: {
