...
function LoginForm() {
  ...
  const handleInputChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (name === 'contact' && value && formData.phone) {
      ...
      setFormData(prev => ({
        ...prev,
        contact: value,
        phone: '' // Clear phone when email is beinged
      }));
  ...
  const handlePhoneChange = (value: string | undefined) => {
    ...
    if (phoneValue && formData.contact) {
      ...
      setFormData(prev => ({
        ...prev,
        phone: phoneValue,
        contact: '' // Clear email when phone is beinged
      }));
    } else {
      setFormData(prev => ({
        ...prev,
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    // Check if both fields areed (should not happen due to input handlers, but safety check)
