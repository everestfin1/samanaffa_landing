    ...
    const fetchSubscription = async () => {
      try {
        ...
        if (data.success && data.subscription) {
          ...
          console.log('[APE Status] User redirected to status page:', {
            referenceNumber,
...
export const Route = createFileRoute('/apesenegal/payment-status')({
  component: ApePaymentStatusPage,
});

export default function ApePaymentStatusPage() {
  return (
    <Suspense fallback={
