...
export const HeroSection: React.FC<HeroSectionProps> = ({ onShowForm }) => {
  return (
    <section className="relative w-full h-[60vh] lg:h-[60vh] overflow-hidden">
      {/* Background image */}
      ...
      <div className="relative w-full h-full z-10">
        ...
        <div className="flex flex-col gap-6 md:grid md:grid-cols-3 md:gap-8 lg:gap-12 xl:gap-16 min-h-[60vh] px-4 sm:px-6 pt-2">
          <div>
          </div>
          {/* Content section - Left side on desktop */}
          <div className="md:rounded-2xl md:backdrop-blur-sm md:bg-white/30 md:px-2 md:py-4 md:my-4 flex-1 flex flex-col justify-start items-center pt-4 text-center md:col-span-1 md:items-start md:text-start space-y-2 lg:space-y-6 max-w-lg md:max-w-none mx-auto md:mx-0 pb-8 md:pb-0 pb-8">
            ...
            {/* CTA button */}
            <div
              className="pt-1 lg:pt-2 mb-4 sm:mb-6 animate-fade-in w-full flex justify-center md:justify-start"
