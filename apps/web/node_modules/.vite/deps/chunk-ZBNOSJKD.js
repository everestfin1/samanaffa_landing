...
// ../../node_modules/@better-auth/core/dist/utils/deprecate.mjs
function deprecate(fn, message, logger2) {
  let warned = false;
  return function(...args) {
    if (!warned) {
      ((logger2 == null ? void 0 : logger2.warn) ?? console.warn)(`[Deprecation] ${message}`);
      warned = true;
    }
...
// ../../node_modules/@better-auth/core/dist/utils/id.mjs
var generateId = (size) => {
...
function isValidIP2(ip) {
  return (void 0)().safeParse(ip).success || (void 0)().safeParse(ip).success;
}
function isIPv6(ip) {
  return (void 0)().safeParse(ip).success;
}
function extractIPv4FromMapped(ipv62) {
  ...
  if (lower.startsWith("::ffff:")) {
    ...
    if ((void 0)().safeParse(ipv4Part).success) return ipv4Part;
  }
  const parts = ipv62.split(":");
  if (parts.length === 7 && ((_a = parts[5]) == null ? void 0 : _a.toLowerCase()) === "ffff") {
    const ipv4Part = parts[6];
    if (ipv4Part && (void 0)().safeParse(ipv4Part).success) return ipv4Part;
  }
...
function normalizeIP(ip, options = {}) {
  if ((void 0)().safeParse(ip).success) return ip.toLowerCase();
...
// ../../node_modules/@better-auth/core/dist/utils/json.mjs
...
var getAuthTables = (options) => {
  ...
  const pluginSchema = (options.plugins ?? []).reduce((acc, plugin) => {
    ...
    for (const [key, value] of Object.entries(schema)) acc[key] = {
      fields: {
        ...(_a2 = acc[key]) == null ? void 0 : _a2.fields,
        ...value.fields
      },
  ...
  const shouldAddRateLimitTable = ((_a = options.rateLimit) == null ? void 0 : _a.storage) === "database";
  const rateLimitTable = { rateLimit: {
    modelName: ((_b = options.rateLimit) == null ? void 0 : _b.modelName) || "rateLimit",
    fields: {
      key: {
        type: "string",
        fieldName: ((_d = (_c = options.rateLimit) == null ? void 0 : _c.fields) == null ? void 0 : _d.key) || "key"
      },
      count: {
        type: "number",
        fieldName: ((_f = (_e = options.rateLimit) == null ? void 0 : _e.fields) == null ? void 0 : _f.count) || "count"
      },
      lastRequest: {
        type: "number",
        bigint: true,
        fieldName: ((_h = (_g = options.rateLimit) == null ? void 0 : _g.fields) == null ? void 0 : _h.lastRequest) || "lastRequest"
      }
    }
  } };
  const { user, session, account, verification, ...pluginTables } = pluginSchema;
  const sessionTable = { session: {
    modelName: ((_i = options.session) == null ? void 0 : _i.modelName) || "session",
    fields: {
      expiresAt: {
        type: "date",
        required: true,
        fieldName: ((_k = (_j = options.session) == null ? void 0 : _j.fields) == null ? void 0 : _k.expiresAt) || "expiresAt"
      },
      token: {
        type: "string",
        required: true,
        fieldName: ((_m = (_l = options.session) == null ? void 0 : _l.fields) == null ? void 0 : _m.token) || "token",
        unique: true
      },
      createdAt: {
        type: "date",
        required: true,
        fieldName: ((_o = (_n = options.session) == null ? void 0 : _n.fields) == null ? void 0 : _o.createdAt) || "createdAt",
        defaultValue: () => /* @__PURE__ */ new Date()
      },
      updatedAt: {
        type: "date",
        required: true,
        fieldName: ((_q = (_p = options.session) == null ? void 0 : _p.fields) == null ? void 0 : _q.updatedAt) || "updatedAt",
        onUpdate: () => /* @__PURE__ */ new Date()
      },
      ipAddress: {
        type: "string",
        required: false,
        fieldName: ((_s = (_r = options.session) == null ? void 0 : _r.fields) == null ? void 0 : _s.ipAddress) || "ipAddress"
      },
      userAgent: {
        type: "string",
        required: false,
        fieldName: ((_u = (_t = options.session) == null ? void 0 : _t.fields) == null ? void 0 : _u.userAgent) || "userAgent"
      },
      userId: {
        type: "string",
        fieldName: ((_w = (_v = options.session) == null ? void 0 : _v.fields) == null ? void 0 : _w.userId) || "userId",
        references: {
          model: ((_x = options.user) == null ? void 0 : _x.modelName) || "user",
          field: "id",
          onDelete: "cascade"
        },
        required: true,
      ...
      ...session == null ? void 0 : session.fields,
      ...(_y = options.session) == null ? void 0 : _y.additionalFields
    },
    order: 2
  } };
  return {
    user: {
      modelName: ((_z = options.user) == null ? void 0 : _z.modelName) || "user",
      fields: {
        name: {
          type: "string",
          required: true,
          fieldName: ((_B = (_A = options.user) == null ? void 0 : _A.fields) == null ? void 0 : _B.name) || "name",
          sortable: true
        },
        email: {
          type: "string",
          unique: true,
          required: true,
          fieldName: ((_D = (_C = options.user) == null ? void 0 : _C.fields) == null ? void 0 : _D.email) || "email",
          sortable: true
        },
        emailVerified: {
          type: "boolean",
          defaultValue: false,
          required: true,
          fieldName: ((_F = (_E = options.user) == null ? void 0 : _E.fields) == null ? void 0 : _F.emailVerified) || "emailVerified",
          input: false
        },
        image: {
          type: "string",
          required: false,
          fieldName: ((_H = (_G = options.user) == null ? void 0 : _G.fields) == null ? void 0 : _H.image) || "image"
        },
        createdAt: {
          type: "date",
          defaultValue: () => /* @__PURE__ */ new Date(),
          required: true,
          fieldName: ((_J = (_I = options.user) == null ? void 0 : _I.fields) == null ? void 0 : _J.createdAt) || "createdAt"
        },
        updatedAt: {
          type: "date",
          defaultValue: () => /* @__PURE__ */ new Date(),
          onUpdate: () => /* @__PURE__ */ new Date(),
          required: true,
          fieldName: ((_L = (_K = options.user) == null ? void 0 : _K.fields) == null ? void 0 : _L.updatedAt) || "updatedAt"
        },
        ...user == null ? void 0 : user.fields,
        ...(_M = options.user) == null ? void 0 : _M.additionalFields
      },
      order: 1
    },
    ...!options.secondaryStorage || ((_N = options.session) == null ? void 0 : _N.storeSessionInDatabase) ? sessionTable : {},
    account: {
      modelName: ((_O = options.account) == null ? void 0 : _O.modelName) || "account",
      fields: {
        accountId: {
          type: "string",
          required: true,
          fieldName: ((_Q = (_P = options.account) == null ? void 0 : _P.fields) == null ? void 0 : _Q.accountId) || "accountId"
        },
        providerId: {
          type: "string",
          required: true,
          fieldName: ((_S = (_R = options.account) == null ? void 0 : _R.fields) == null ? void 0 : _S.providerId) || "providerId"
        },
        userId: {
          type: "string",
          references: {
            model: ((_T = options.user) == null ? void 0 : _T.modelName) || "user",
            field: "id",
            onDelete: "cascade"
          },
          required: true,
          fieldName: ((_V = (_U = options.account) == null ? void 0 : _U.fields) == null ? void 0 : _V.userId) || "userId",
          index: true
        },
        accessToken: {
          type: "string",
          required: false,
          returned: false,
          fieldName: ((_X = (_W = options.account) == null ? void 0 : _W.fields) == null ? void 0 : _X.accessToken) || "accessToken"
        },
        refreshToken: {
          type: "string",
          required: false,
          returned: false,
          fieldName: ((_Z = (_Y = options.account) == null ? void 0 : _Y.fields) == null ? void 0 : _Z.refreshToken) || "refreshToken"
        },
        idToken: {
          type: "string",
          required: false,
          returned: false,
          fieldName: ((_$ = (__ = options.account) == null ? void 0 : __.fields) == null ? void 0 : _$.idToken) || "idToken"
        },
        accessTokenExpiresAt: {
          type: "date",
          required: false,
          returned: false,
          fieldName: ((_ba = (_aa = options.account) == null ? void 0 : _aa.fields) == null ? void 0 : _ba.accessTokenExpiresAt) || "accessTokenExpiresAt"
        },
        refreshTokenExpiresAt: {
          type: "date",
          required: false,
          returned: false,
          fieldName: ((_da = (_ca = options.account) == null ? void 0 : _ca.fields) == null ? void 0 : _da.refreshTokenExpiresAt) || "refreshTokenExpiresAt"
        },
        scope: {
          type: "string",
          required: false,
          fieldName: ((_fa = (_ea = options.account) == null ? void 0 : _ea.fields) == null ? void 0 : _fa.scope) || "scope"
        },
        password: {
          type: "string",
          required: false,
          returned: false,
          fieldName: ((_ha = (_ga = options.account) == null ? void 0 : _ga.fields) == null ? void 0 : _ha.password) || "password"
        },
        createdAt: {
          type: "date",
          required: true,
          fieldName: ((_ja = (_ia = options.account) == null ? void 0 : _ia.fields) == null ? void 0 : _ja.createdAt) || "createdAt",
          defaultValue: () => /* @__PURE__ */ new Date()
        },
        updatedAt: {
          type: "date",
          required: true,
          fieldName: ((_la = (_ka = options.account) == null ? void 0 : _ka.fields) == null ? void 0 : _la.updatedAt) || "updatedAt",
          onUpdate: () => /* @__PURE__ */ new Date()
        },
        ...account == null ? void 0 : account.fields,
        ...(_ma = options.account) == null ? void 0 : _ma.additionalFields
      },
      order: 3
    },
    verification: {
      modelName: ((_na = options.verification) == null ? void 0 : _na.modelName) || "verification",
      fields: {
        identifier: {
          type: "string",
          required: true,
          fieldName: ((_pa = (_oa = options.verification) == null ? void 0 : _oa.fields) == null ? void 0 : _pa.identifier) || "identifier",
          index: true
        },
        value: {
          type: "string",
          required: true,
          fieldName: ((_ra = (_qa = options.verification) == null ? void 0 : _qa.fields) == null ? void 0 : _ra.value) || "value"
        },
        expiresAt: {
          type: "date",
          required: true,
          fieldName: ((_ta = (_sa = options.verification) == null ? void 0 : _sa.fields) == null ? void 0 : _ta.expiresAt) || "expiresAt"
        },
        createdAt: {
          type: "date",
          required: true,
          defaultValue: () => /* @__PURE__ */ new Date(),
          fieldName: ((_va = (_ua = options.verification) == null ? void 0 : _ua.fields) == null ? void 0 : _va.createdAt) || "createdAt"
        },
        updatedAt: {
          type: "date",
          required: true,
          defaultValue: () => /* @__PURE__ */ new Date(),
          onUpdate: () => /* @__PURE__ */ new Date(),
          fieldName: ((_xa = (_wa = options.verification) == null ? void 0 : _wa.fields) == null ? void 0 : _xa.updatedAt) || "updatedAt"
        },
        ...verification == null ? void 0 : verification.fields,
        ...(_ya = options.verification) == null ? void 0 : _ya.additionalFields
      },
      order: 4
    },
    ...pluginTables,
...
var initGetDefaultModelName = ({ usePlural, schema }) => {
  const getDefaultModelName = (model) => {
    ...
    if (usePlural && model.charAt(model.length - 1) === "s") {
      ...
      if (!m$1) m$1 = (_a = Object.entries(schema).find(([_, f]) => f.modelName === pluralessModel)) == null ? void 0 : _a[0];
      if (m$1) return m$1;
    }
    let m = schema[model] ? model : void 0;
    if (!m) m = (_b = Object.entries(schema).find(([_, f]) => f.modelName === model)) == null ? void 0 : _b[0];
...
var initGetDefaultFieldName = ({ schema, usePlural }) => {
  ...
  const getDefaultFieldName = ({ field, model: unsafeModel }) => {
    ...
    let f = (_a = schema[model]) == null ? void 0 : _a.fields[field];
    if (!f) {
...
// ../../node_modules/@better-auth/core/dist/db/adapter/get-id-field.mjs
var initGetIdField = ({ usePlural, schema, disableIdGeneration, options, customIdGenerator, supportsUUIDs }) => {
  ...
  const idField = ({ customModelName, forceAllowId }) => {
    ...
    const useNumberId = ((_b = (_a = options.advanced) == null ? void 0 : _a.database) == null ? void 0 : _b.useNumberId) || ((_d = (_c = options.advanced) == null ? void 0 : _c.database) == null ? void 0 : _d.generateId) === "serial";
    const useUUIDs = ((_f = (_e = options.advanced) == null ? void 0 : _e.database) == null ? void 0 : _f.generateId) === "uuid";
    ...
    return {
      ...
      ...shouldGenerateId ? { defaultValue() {
        ...
        const generateId$1 = (_b2 = (_a2 = options.advanced) == null ? void 0 : _a2.database) == null ? void 0 : _b2.generateId;
        ...
        input: (value) => {
          ...
          if (useUUIDs) {
            ...
            if (forceAllowId && typeof value === "string") if (/^[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/i.test(value)) return value;
              ...
              const stack = (_a2 = new Error().stack) == null ? void 0 : _a2.split("\n").filter((_, i) => i !== 1).join("\n").replace("Error:", "");
...
// ../../node_modules/@better-auth/core/dist/db/adapter/get-field-attributes.mjs
...
var initGetFieldName = ({ schema, usePlural }) => {
  ...
  function getFieldName({ model: modelName, field: fieldName }) {
    ...
    return ((_b = (_a = schema[model]) == null ? void 0 : _a.fields[field]) == null ? void 0 : _b.fieldName) || field;
  }
  return getFieldName;
};
...
// ../../node_modules/@better-auth/core/dist/db/adapter/utils.mjs
...
var createAdapterFactory = ({ adapter: customAdapter, config: cfg }) => (options) => {
  ...
  if ((((_b = (_a = options.advanced) == null ? void 0 : _a.database) == null ? void 0 : _b.useNumberId) === true || ((_d = (_c = options.advanced) == null ? void 0 : _c.database) == null ? void 0 : _d.generateId) === "serial") && config.supportsNumericIds === false) throw new BetterAuthError(`[${config.adapterName}] Your database or database adapter does not support numeric ids. Please disable "useNumberId" in your config.`);
  ...
  const debugLog = (...args) => {
    ...
    if (config.debugLogs === true || typeof config.debugLogs === "object") {
      ...
      if (typeof config.debugLogs === "object" && config.debugLogs.logCondition && !((_b2 = (_a2 = config.debugLogs).logCondition) == null ? void 0 : _b2.call(_a2))) return;
  ...
  const transformInput = async (data, defaultModelName, action, forceAllowId) => {
    ...
    const useNumberId = ((_b2 = (_a2 = options.advanced) == null ? void 0 : _a2.database) == null ? void 0 : _b2.useNumberId) || ((_d2 = (_c2 = options.advanced) == null ? void 0 : _c2.database) == null ? void 0 : _d2.generateId) === "serial";
    fields.id = idField({
    ...
    for (const field in fields) {
      ...
      if (value === void 0 && (fieldAttributes.defaultValue === void 0 && !((_e2 = fieldAttributes.transform) == null ? void 0 : _e2.input) && !(action === "update" && fieldAttributes.onUpdate) || action === "update" && !fieldAttributes.onUpdate)) continue;
      ...
      if ((_f = fieldAttributes.transform) == null ? void 0 : _f.input) newValue = await fieldAttributes.transform.input(newValue);
      if (((_g = fieldAttributes.references) == null ? void 0 : _g.field) === "id" && useNumberId) if (Array.isArray(newValue)) newValue = newValue.map((x) => x !== null ? Number(x) : null);
  ...
  const transformOutput = async (data, unsafe_model, select = [], join) => {
    const transformSingleOutput = async (data$1, unsafe_model$1, select$1 = []) => {
      ...
      const idKey = (_a2 = Object.entries(newMappedKeys).find(([_, v]) => v === "id")) == null ? void 0 : _a2[0];
      tableSchema[idKey ?? "id"] = { type: ((_c2 = (_b2 = options.advanced) == null ? void 0 : _b2.database) == null ? void 0 : _c2.useNumberId) || ((_e2 = (_d2 = options.advanced) == null ? void 0 : _d2.database) == null ? void 0 : _e2.generateId) === "serial" ? "number" : "string" };
      for (const key in tableSchema) {
        if (select$1.length && !select$1.includes(key)) continue;
        const field = tableSchema[key];
        if (field) {
          const originalKey = field.fieldName || key;
          let newValue = data$1[((_f = Object.entries(newMappedKeys).find(([_, v]) => v === originalKey)) == null ? void 0 : _f[0]) || originalKey];
          if ((_g = field.transform) == null ? void 0 : _g.output) newValue = await field.transform.output(newValue);
          const newFieldName = newMappedKeys[key] || key;
          if (originalKey === "id" || ((_h = field.references) == null ? void 0 : _h.field) === "id") {
    ...
    for (const { modelName, defaultModelName, joinConfig } of requiredModels) {
      let joinedData = await (async () => {
        var _a2;
        if ((_a2 = options.experimental) == null ? void 0 : _a2.joins) return data[modelName];
  ...
  const transformWhereClause = ({ model, where, action }) => {
    ...
    return where.map((w) => {
      ...
      const useNumberId = ((_b2 = (_a2 = options.advanced) == null ? void 0 : _a2.database) == null ? void 0 : _b2.useNumberId) || ((_d2 = (_c2 = options.advanced) == null ? void 0 : _c2.database) == null ? void 0 : _d2.generateId) === "serial";
      if (defaultFieldName === "id" || ((_e2 = fieldAttr.references) == null ? void 0 : _e2.field) === "id") {
  ...
  const transformJoinClause = (baseModel, unsanitizedJoin, select) => {
    ...
    for (const [model, join] of Object.entries(unsanitizedJoin)) {
      ...
      let limit = ((_b2 = (_a2 = options.advanced) == null ? void 0 : _a2.database) == null ? void 0 : _b2.defaultFindManyLimit) ?? 100;
      if (isUnique) limit = 1;
  ...
  const handleFallbackJoin = async ({ baseModel, baseData, joinModel, specificJoinConfig: joinConfig }) => {
    ...
    try {
      if (joinConfig.relation === "one-to-one") result = await adapterInstance.findOne({
        ...
        const limit = joinConfig.limit ?? ((_b2 = (_a2 = options.advanced) == null ? void 0 : _a2.database) == null ? void 0 : _b2.defaultFindManyLimit) ?? 100;
  ...
  const adapter = {
    ...
    findOne: async ({ model: unsafeModel, where: unsafeWhere, select, join: unsafeJoin }) => {
      ...
      if (!config.disableTransformJoin) {
        ...
        if (!((_a2 = options.experimental) == null ? void 0 : _a2.joins) && join && Object.keys(join).length > 0) passJoinToAdapter = false;
    ...
    findMany: async ({ model: unsafeModel, where: unsafeWhere, limit: unsafeLimit, sortBy, offset, join: unsafeJoin }) => {
      ...
      transactionId++;
      const thisTransactionId = transactionId;
      const limit = unsafeLimit ?? ((_b2 = (_a2 = options.advanced) == null ? void 0 : _a2.database) == null ? void 0 : _b2.defaultFindManyLimit) ?? 100;
      const model = getModelName(unsafeModel);
      const where = transformWhereClause({
        model: unsafeModel,
        where: unsafeWhere,
      ...
      if (!config.disableTransformJoin) {
        ...
        if (!((_c2 = options.experimental) == null ? void 0 : _c2.joins) && join && Object.keys(join).length > 0) passJoinToAdapter = false;
      } else join = unsafeJoin;
    ...
    createSchema: adapterInstance.createSchema ? async (_, file) => {
      ...
      if (options.secondaryStorage && !((_a2 = options.session) == null ? void 0 : _a2.storeSessionInDatabase)) delete tables.session;
      if (options.rateLimit && options.rateLimit.storage === "database" && (typeof options.rateLimit.enabled === "undefined" || options.rateLimit.enabled === true)) tables.ratelimit = {
        ...
        fields: {
          key: {
            ...
            unique: true,
            required: true,
            fieldName: ((_b2 = options.rateLimit.fields) == null ? void 0 : _b2.key) ?? "key"
          },
          count: {
            type: "number",
            required: true,
            fieldName: ((_c2 = options.rateLimit.fields) == null ? void 0 : _c2.count) ?? "count"
          },
          lastRequest: {
            type: "number",
            required: true,
            ...
            fieldName: ((_d2 = options.rateLimit.fields) == null ? void 0 : _d2.lastRequest) ?? "lastRequest"
          }
        }
      };
    ...
    id: config.adapterId,
    ...((_e = config.debugLogs) == null ? void 0 : _e.isRunningAdapterTests) ? { adapterTestDebugLogs: {
      resetDebugLogs() {
...
//# sourceMappingURL=chunk-ZBNOSJKD.js.map
