...
var createKyselyAdapter = async (config) => {
  ...
  if ("fileControl" in db) {
    const { BunSqliteDialect } = await import("./bun-sqlite-dialect-NFTVOPSN.js");
  ...
  if ("createSession" in db && typeof window === "undefined") {
    ...
    if (DatabaseSync && db instanceof DatabaseSync) {
      const { NodeSqliteDialect } = await import("./node-sqlite-dialect-JAFBNFAN.js");
...
//# sourceMappingURL=chunk-Q3BAU6Z5.js.map
