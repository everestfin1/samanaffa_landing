...
function PaymentSuccessContent() {
  ...
  const numTransactionFromGu = searchParams.num_transaction_from_gu;
    ...
    if (!processing) {
      const timer = setInterval(() => {
        setCountdown((prev) => {
          if (prev <= 1) {
            clearInterval(timer);
            (navigate as any)({ to: '/portal/sama-naffa' });
            return 0;
          }
          return prev - 1;
        });
      ...
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl border border-gold-metallic/20 p-8">
        <div className="text-center">
          ...
          <div className="space-y-3">
            ...
            <button
              onClick={() => (navigate as any)({ to: '/portal/dashboard' })}
...
export const Route = createFileRoute('/portal/sama-naffa/payment-success')({
